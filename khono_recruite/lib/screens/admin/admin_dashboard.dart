...
class _AdminPalette {
  ...
  /// Widget surface: #FFFFFF (white) at 14% opacity per specification.
  static Color _darkWidgetSurface() =>
      const Color(0xFFFFFFFF).withValues(alpha: 0.14);

  /// Light mode: same as dark mode per specification.
  static Color _lightWidgetSurface() =>
      const Color(0xFFFFFFFF).withValues(alpha: 0.14);
}
          ...
          SafeArea(
            child: Row(
              children: [
                // ---------- Sidebar ----------
                AdminSidebar(
                  animation: const AlwaysStoppedAnimation(192),
                  ...
                  sections: [
                    AdminNavSection(
                      items: [
                        AdminNavItem(
                          title: 'Dashboard',
                          iconAsset: 'assets/icons/Dashboard/dashboard.png',
                          screen: 'dashboard',
                        ),
                        AdminNavItem(
                          title: 'Jobs',
                          iconAsset: 'assets/icons/Dashboard/jobs.png',
                          screen: 'jobs',
                        ),
                        AdminNavItem(
                          title: 'Candidates',
                          iconAsset: 'assets/icons/Dashboard/candidates.png',
                          screen: 'candidates',
                        ),
                        AdminNavItem(
                          title: 'Interviews',
                          iconAsset: 'assets/icons/Dashboard/interviews.png',
                          screen: 'interviews',
                        ),
                        AdminNavItem(
                          title: 'CV Reviews',
                          iconAsset: 'assets/icons/Dashboard/cvreviews.png',
                          screen: 'cv_reviews',
                        ),
                      ],
                    ),
                    AdminNavSection(
                      items: [
                        AdminNavItem(
                          title: 'Analytics',
                          iconAsset: 'assets/icons/Dashboard/analytics.png',
                          screen: 'analytics',
                        ),
                        AdminNavItem(
                          title: 'Team Collaboration',
                          iconAsset:
                              'assets/icons/Dashboard/teamcollaborations.png',
                          screen: 'team_collaboration',
                        ),
                      ],
                    ),
                    AdminNavSection(
                      items: [
                        AdminNavItem(
                          title: 'Audits',
                          iconAsset: 'assets/icons/Dashboard/audits.png',
                          screen: 'audits',
                        ),
                        AdminNavItem(
                          title: 'Settings',
                          iconAsset: 'assets/icons/Dashboard/settings.png',
                          screen: 'settings',
                        ),
                        AdminNavItem(
                          title: 'User Management',
                          iconAsset:
                              'assets/icons/Dashboard/usermanagement.png',
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: Image.asset(
          themeProvider.isDarkMode
              ? 'assets/icons/Dashboard/settings.png'
              : 'assets/icons/Dashboard/settings.png',
          width: 24,
          height: 24,
          color: Colors.white,
  ...
  Widget _placeholderScreen(String title) {
    ...
    return Center(
      child: Column(
        ...
        children: [
          Image.asset('assets/icons/Dashboard/settings.png',
              width: 44,
              height: 44,
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Image.asset('assets/icons/Dashboard/calender.png',
                        width: 22, height: 22),
                  ),
          ...
          Row(
            children: [
              Container(
                ...
                child: Image.asset('assets/icons/Dashboard/updates.png',
                    width: 20, height: 20),
              ),
              const SizedBox(width: 8),
